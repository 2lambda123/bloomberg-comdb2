 ...
 */
public class Comdb2DatabaseMetaDataResultSet implements ResultSet {

    protected ResultSet rs;
    protected ResultSetMetaData md;
    protected int ord_pos;

    public Comdb2DatabaseMetaDataResultSet(ResultSet rs) {
        this.rs = rs;
        ord_pos = 0;
        try {
            md = rs.getMetaData();
        } catch (SQLException e) {
            // do nothing. getMetaData() never fails.
        }
    }
    ...
    public short getShort(int columnIndex) throws SQLException {
        return (short)rs.getInt(columnIndex);
    }
    ...
    public short getShort(String columnLabel) throws SQLException {
        return (short)rs.getInt(columnLabel);
    }
    ...
    public long getLong(String columnLabel) throws SQLException {
        return (long)rs.getInt(columnLabel);
    }
